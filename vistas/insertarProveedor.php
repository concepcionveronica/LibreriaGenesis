...
<?php include 'layouts/headerStyle.php'; ?>
    ...
    <body>
        ...
        <div class="col-md-4">
          ...
          <form method="POST" class="guardar_datos" id="guardar_los_datos" action="Conexion/ControladorProveedor.php">
          ...
          <div class="form-group">
              ...
              <select name="select" class="form-control" autocomplete="off" name="tipoP" id="tipoP" placeholder="Ingrese su opcion">
              <option value="value1" class="form-control">Persona Natural</option>
              <option value="value2" class="form-control">Persona Juridica</option>
              </select> 
